	...
	<div class="content_area">
		...
		<div class="flex-container space-between"
			...
			<c:forEach var="g_s" items="${getShoes }">
				<div>
					<img src="data:image/jpeg;base64,${g_s.product_img_base64}"
						style="width: 230px; height: 230px;"><br>
					${g_s.product_name }
					<input name="product_price" value="${g_s.product_price }" type="checkbox">
					<div><input readonly="readonly" value="${g_s.product_price }" style="border:none; outline: none; "></div>
				</div>
				<br>
			</c:forEach>
			<div>
