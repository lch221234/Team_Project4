		...
		<div class="flex-container space-between"
			...
			<c:forEach var="g_t" items="${getTop }">
				<div>
					...
					${g_t.product_name }
					<input name="product_price" value="${g_t.product_price }" type="checkbox">
					<div><input readonly="readonly" value="${g_t.product_price }" style="border:none; outline: none; "></div>
				</div>
				<br>
			</c:forEach>
			<div>
