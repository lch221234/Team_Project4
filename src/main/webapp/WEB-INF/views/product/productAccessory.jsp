...
<body>
	...
	<form action="productAc.Buy">
	<div class="content_area">
		<!-- 메인제품 구역 -->
		<div class="flex-container space-between"
			style="display: flex; justify-content: space-between; flex-wrap: wrap;">
			<c:forEach var="g_a" items="${getAccessory }">
				<div>
					<img src="data:image/jpeg;base64,${g_a.product_img_base64}"
						style="width: 230px; height: 230px;"><br>
					${g_a.product_name }
					<input name="product_price" value="${g_a.product_price }" type="checkbox">
					<div><input readonly="readonly" value="${g_a.product_price }" style="border:none; outline: none; "></div>
				</div>
				<br>
			</c:forEach>
			<div>
